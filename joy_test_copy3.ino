...
void dumpGamepad(ControllerPtr ctl) {
    ...
    led_ctrl(0,map(ctl->axisX(),-511,512,0,255));
    led_ctrl(1,map(ctl->axisY(),-511,512,255,0));
    led_ctrl(2,map(ctl->axisRX(),-511,512,0,255));
    led_ctrl(3,map(ctl->axisRY(),-511,512,255,0));
}
